...
\par \emph{HQ Service} wymaga skonfigurowania \texttt{HqAgentSettings}. Możliwe ustawienia przedstawia tabela \ref{tab:configurationHqServiceSettings}.
% TODO Dodać opis konfiguracji algorytmu decyzyjnego
