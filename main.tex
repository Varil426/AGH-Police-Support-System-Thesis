...
\include{chapters/23_systemy_agentowe}
\include{chapters/24_komunikacja_asynchroniczna_w_systemach_rozproszonych}
\include{chapters/25_przetwarzanie_i_wykorzystywanie_danych_geograficznych}
\include{chapters/26_symulowanie_jednostek_w_miescie}
...
\include{chapters/algorytmDecyzyjny}
\include{chapters/34_integracja_z_postgis}
\include{chapters/35_interfejs_uzytkownika}
\include{chapters/36_symulacja}
\include{chapters/konteneryzacja_systemu}
\include{chapters/konfiguracja}
\include{chapters/40_metodologia_i_analiza_wynikow_badan}
\include{chapters/41_problem_badawczy}
\include{chapters/42_wybor_metody_badawczej_i_uzasadnienie}
\include{chapters/43_uzyskane_wyniki_i_ich_analiza}
\include{chapters/99_conclusion}

% itd.
\appendix
\include{appendages/uruchamianie_i_konfiguracja}
% \include{dodatekB}
% itd.
